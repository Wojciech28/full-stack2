...
inputs.addEventListener("keyup",(e)=>{
   ...
   for(let i=0 ; i< data.length; i++){
      if(data[i].name.first.toUpperCase().includes(inputs.value.toUpperCase())||data[i].name.last.toUpperCase().includes(inputs.value.toUpperCase())){
         datanew.push(data[i]);       
      }
   }
   ...
   document.querySelector('.searched').classList.add("active");
